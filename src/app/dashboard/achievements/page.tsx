...
const ALL_ACHIEVEMENTS = [
  ...
  { key: 'power_user',      name: 'Power User',      description: 'Using advanced productivity features.',                 icon: Zap,         color: 'text-[#10B981]',  bg: 'bg-indigo-400/20'  },
      ...
      {unlockedKeys.length === 0 ? (
        <div className="pt-10">
          <EmptyState
            ...
            description="Complete study blocks, maintain streaks, and hit your goals to unlock badges."
          />
        </div>
      ) : (
            ...
            return (
              <div
                ...
                className={`bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl p-5 flex flex-col items-center text-center gap-3
                            transition-all duration-150-all duration-200
                            ${isUnlocked
