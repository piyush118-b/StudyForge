...
function DropdownMenuLabel({
  ...
  return (
    <MenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn(
        "px-3 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-[#606060] data-inset:pl-8",
        className
      )}
      {...props}
    />
